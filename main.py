...
# --- Frontier Compute Briefings (60+ posts — neural thesis, no trademark claims) ---
FRONTIER_COMPUTE_BRIEFINGS = [
    ...
    "🧠 **FRONTIER COMPUTE BRIEFING**\n\n120kW per rack. PUE under 1.15. Direct-to-chip liquid cooling.\n\nThese aren't specs to be proud of. They're the minimum requirement to run the next generation of neural and AI workloads.\n\nFacilities that can't hit this density will be obsolete within five years.",
    ...
    "🧠 **FRONTIER COMPUTE BRIEFING**\n\nGeographic moats in compute are real.\n\n• Sub-2.5ms to Singapore\n• Direct subsea fiber to Jakarta, Hong Kong\n• 15-year 0% corporate tax\n• Sovereign land title, 80+ year lease\n\nBatam SEZ isn't a location. It's a strategy.",
    "🧠 **FRONTIER COMPUTE BRIEFING**\n\nThe next compute cycle won't be won by the biggest facility.\n\nIt'll be won by the one positioned where the workloads need it — close enough to the market for latency, distant enough from the grid for cost, protected enough from politics for certainty.\n\nBatam SEZ checks all three.",
    ...
    "🧠 **FRONTIER COMPUTE BRIEFING**\n\nNeural interfaces are the frontier. But they're built on a foundation:\n\n• Silicon (chips)\n• Power (grid)\n• Cooling (thermal)\n• Land (sovereign)\n\nAI Grid Indonesia owns the foundation.",
    ...
    "🧠 **FRONTIER COMPUTE BRIEFING**\n\nDirect-to-chip liquid cooling isn't optional anymore.\n\nAt 120kW per rack, air can't remove the heat. You either deploy liquid cooling or you don't run the next generation of chips.\n\nAI Grid Indonesia deploys liquid from day one.",
    ...
    "🧠 **FRONTIER COMPUTE BRIEFING**\n\nThe next generation of AI models won't run in Silicon Valley.\n\nNot because Silicon Valley can't build them. Because Silicon Valley can't power them.\n\nCompute is migrating to where the power and land are. Southeast Asia is first in line.",
